    ...
    <div className="w-full">
      ...
      <section className="py-24 px-6 md:px-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-sm border border-outline-variant/30 relative order-1 lg:order-2">
            <Image
              src="https://qnelsjzfuynqotkwojxv.supabase.co/storage/v1/object/public/saiiiw/services/individual_counsellings.jpeg"
              alt="Individual Islamic counselling and faith-based therapy session"
              fill
      ...
      <section className="py-24 px-6 md:px-20 max-w-4xl mx-auto text-center">
        ...
        <p className="text-on-surface-variant mb-12 leading-relaxed text-lg">
          We combine psychology with Quran and Sunnah-guided wellness practices. As experts in Islamic psychology counselling, our therapists create a safe and respectful space that honours your values, beliefs and personal journey.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              ...
              <p className="text-on-surface-variant text-sm">Professional psychological methodologies tailored for your wellbeing.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Faith-sensitive coping tools</h3>
              <p className="text-on-surface-variant text-sm">Integrating spiritual counselling insights to overcome difficulties.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Goal setting and emotional development</h3>
              <p className="text-on-surface-variant text-sm">Actionable steps toward resilience, peace, and personal discovery.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Quran and Sunnah based wellness</h3>
              <p className="text-on-surface-variant text-sm">When appropriate, guided by Islamic counselling principles to anchor healing.</p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              ...
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Intake Session</h3>
              <p className="text-on-surface-variant relative z-10">
                Understanding your history and concerns.
              </p>
            </div>
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              <div className="font-serif text-8xl absolute -top-4 -right-2 text-surface-variant/40 font-bold">2</div>
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Treatment Plan</h3>
              <p className="text-on-surface-variant relative z-10">
                Collaboratively designing your therapy journey.
              </p>
            </div>
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              <div className="font-serif text-8xl absolute -top-4 -right-2 text-surface-variant/40 font-bold">3</div>
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Ongoing Counselling</h3>
              <p className="text-on-surface-variant relative z-10">
                Regular sessions focused on healing and growth.
              </p>
            </div>
          </div>
        </div>
