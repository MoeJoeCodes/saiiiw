...
export const metadata: Metadata = {
  title: 'Career Counselling in South Africa and Internationally | Islamic Psychology Therapy',
  description:
    'Confidential career counselling using an Islamic integrated approach. Get support for professional growth, decision making, and workplace stress. Book a session today.',
};
    ...
    <div className="w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          <div className="flex flex-col justify-center order-2 lg:order-1">
            ...
            <p className="text-on-surface-variant mb-6 leading-relaxed text-lg">
              Career counselling provides a supportive, structured space where individuals can explore their professional trajectory, improve workplace wellbeing, and make informed career decisions. Our approach combines evidence-based psychological tools with Islamic spiritual wellness, offering holistic guidance.
            </p>
            <p className="text-on-surface-variant leading-relaxed text-lg">
              This service supports professionals across South Africa and internationally seeking clarity, balance, and growth. Whether you are navigating a career transition, managing stress, or seeking alignment with your values, you can find the supportive path you are looking for.
            </p>
          </div>
          <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-sm border border-outline-variant/30 relative order-1 lg:order-2">
            <Image
              src="https://qnelsjzfuynqotkwojxv.supabase.co/storage/v1/object/public/saiiiw/services/Career_Counsellingss.jpeg"
              alt="Career Islamic counselling and faith-based professional therapy session"
              fill
      ...
      <section className="py-24 bg-surface px-6 md:px-20">
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <p className="text-on-surface-variant text-lg">
            Our career therapy and counselling services in South Africa and internationally can provide relief and growth for a range of professional challenges and transitions.
          </p>
        </div>
        <div className="max-w-5xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
          {[
            ...
            'Strengths and skills discovery',
            'Overcoming professional stagnation',
            'Aligning career with faith and values',
          ].map((item, idx) => (
      ...
      <section className="py-24 px-6 md:px-20 max-w-4xl mx-auto text-center">
        ...
        <p className="text-on-surface-variant mb-12 leading-relaxed text-lg">
          We combine career and organizational psychology with Quran and Sunnah-guided wellness practices. As experts in Islamic psychology counselling, our therapists create a supportive space that honours your professional ambitions and spiritual values.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Evidence-based professional techniques</h3>
              <p className="text-on-surface-variant text-sm">Professional psychological methodologies tailored to enhance workplace performance and satisfaction.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Faith-sensitive career advice</h3>
              <p className="text-on-surface-variant text-sm">Integrating spiritual counselling insights to overcome difficulties in the professional sphere.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Actionable goal setting</h3>
              <p className="text-on-surface-variant text-sm">Structured steps toward career resilience, clear decision-making, and reaching your potential.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Values-aligned professional growth</h3>
              <p className="text-on-surface-variant text-sm">Ensuring your career decisions and work-life balance harmonise with your core religious values.</p>
            </div>
          </div>
        </div>
        <p className="mt-12 text-sm text-on-surface-variant font-medium tracking-wide border-t border-outline-variant/20 pt-6 inline-block">
          All sessions are strictly confidential to ensure a safe space for professional exploration.
        </p>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              ...
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Initial Discovery</h3>
              <p className="text-on-surface-variant relative z-10">
                Understanding your career history, current challenges, and professional aspirations.
              </p>
            </div>
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              <div className="font-serif text-8xl absolute -top-4 -right-2 text-surface-variant/40 font-bold">2</div>
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Career Strategy</h3>
              <p className="text-on-surface-variant relative z-10">
                Collaboratively designing a personalized approach for your career development.
              </p>
            </div>
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              ...
              <p className="text-on-surface-variant relative z-10">
                Structured follow-up sessions to guide implementation, assess progress, and adjust goals.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-24 px-6 md:px-20 max-w-3xl mx-auto text-center">
        ...
        <p className="text-on-surface-variant leading-relaxed text-lg mb-8">
          We provide professional career counselling services to clients across South Africa and internationally. Sessions are offered in a safe, confidential and supportive environment designed to help you navigate your professional trajectory with clarity and confidence.
        </p>
