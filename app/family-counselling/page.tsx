    ...
    <div className="w-full">
      ...
      <section className="py-24 px-6 md:px-20 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="w-full aspect-[4/3] rounded-3xl overflow-hidden shadow-sm border border-outline-variant/30 relative order-1 lg:order-2">
            <Image
              src="https://qnelsjzfuynqotkwojxv.supabase.co/storage/v1/object/public/saiiiw/services/Family_Counsellings.jpeg"
              alt="Family Islamic counselling and faith-based therapy session"
              fill
      ...
      <section className="py-24 px-6 md:px-20 max-w-4xl mx-auto text-center">
        ...
        <p className="text-on-surface-variant mb-12 leading-relaxed text-lg">
          We combine family systems psychology with Quran and Sunnah-guided wellness practices. As experts in Islamic psychology counselling, our therapists create a safe space that honours your family's unique values and dynamics.
        </p>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Evidence-based systemic techniques</h3>
              <p className="text-on-surface-variant text-sm">Professional psychological methodologies tailored for family systems and relationships.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              ...
              <p className="text-on-surface-variant text-sm">Integrating spiritual counselling insights to overcome family difficulties together.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Goal setting & structural support</h3>
              <p className="text-on-surface-variant text-sm">Actionable steps toward resilience, mutual understanding, and renewed family bonds.</p>
            </div>
          </div>
          ...
          <div className="bg-surface p-8 rounded-3xl border border-outline-variant/30 flex items-start gap-4 shadow-sm relative overflow-hidden group z-0">
            ...
            <div className="relative z-10">
              <h3 className="font-semibold text-on-surface mb-2">Quran & Sunnah based family values</h3>
              <p className="text-on-surface-variant text-sm">When appropriate, guided by Islamic principles to anchor your family relationships.</p>
            </div>
          </div>
        </div>
        <p className="mt-12 text-sm text-on-surface-variant font-medium tracking-wide border-t border-outline-variant/20 pt-6 inline-block">
          All sessions are strictly confidential to ensure a safe space for every family member.
        </p>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              ...
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Initial Family Intake</h3>
              <p className="text-on-surface-variant relative z-10">
                Understanding your family history and concerns together in a welcoming environment.
              </p>
            </div>
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              <div className="font-serif text-8xl absolute -top-4 -right-2 text-surface-variant/40 font-bold">2</div>
              <h3 className="text-xl font-bold text-on-surface mb-4 relative z-10">Family Therapy Plan</h3>
              <p className="text-on-surface-variant relative z-10">
                Collaboratively designing your family's therapy journey for maximum growth.
              </p>
            </div>
            <div className="bg-background rounded-3xl p-10 shadow-sm border border-outline-variant/20 relative overflow-hidden text-center">
              ...
              <p className="text-on-surface-variant relative z-10">
                Regular structured sessions focused on communication, healing, and family bonds.
              </p>
            </div>
          </div>
        </div>
